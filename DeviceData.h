...
bool spammer_running = false;
std::vector<CompanyType> selectedTypes;
...
// Global Samsung watch_models array
...
// Apple device names
extern const char* APPLE_DEVICE_NAMES[] = {
    "AirPods", "AirPods Pro", "AirPods Max", "AirPods Gen 2", "AirPods Gen 3", "AirPods Pro Gen 2",
    "Power Beats", "Power Beats Pro", "Beats Solo Pro", "Beats Studio Buds", "Beats Flex", "Beats X",
    "Beats Solo 3", "Beats Studio 3", "Beats Studio Pro", "Beats Fit Pro", "Beats Studio Buds Plus",
    "AppleTV Setup", "AppleTV Pair", "AppleTV New User", "AppleTV AppleID Setup", "AppleTV Wireless Audio Sync",
    "AppleTV Homekit Setup", "AppleTV Keyboard Setup", "AppleTV Connecting to Network", "Homepod Setup",
    "Setup New Phone", "Transfer Number", "TV Color Balance", "Vision Pro"
};
